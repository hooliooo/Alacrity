...
public struct AlacrityButtonDSL: AlacrityDSL, ControlDSL {
...
public extension AlacrityButtonDSL {
    ...
    */
    @discardableResult
    func setAttributedTitle(_ title: NSAttributedString, for state: UIControl.State) -> AlacrityButtonDSL {
    ...
    */
    @discardableResult
    func setBackgroundImage(_ image: UIImage?, for state: UIControl.State) -> AlacrityButtonDSL {
    ...
    */
    @discardableResult
    func setImage(_ image: UIImage?, for state: UIControl.State) -> AlacrityButtonDSL {
    ...
    */
    @discardableResult
    func setTitle(_ title: String, for state: UIControl.State) -> AlacrityButtonDSL {
    ...
    */
    @discardableResult
    func setTitleColor(_ color: UIColor, for state: UIControl.State) -> AlacrityButtonDSL {
    ...
    */
    @discardableResult
    func setTitleShadowColor(_ color: UIColor, for state: UIControl.State) -> AlacrityButtonDSL {
